...
from .routers import health_router, gdpr_router, analytics_router

# ───────────── rate-limit defaults ─────────────
# Use configured default rate limit for all routes
...
for pm in registry.values():
    for route in pm.routes:
        ...
        if isinstance(route, APIRouter):
            # Router already defines its own prefix; include as-is
